...
---
## 欧洲氛围感图片1
<img src="../assets/欧洲海报12.png" width="500" alt="效果图">
...
---
## 旅游标注图片1
<img src="../assets/风景标注2.png" width="500" alt="效果图">
...
**提示词：**
想象你是一个疯狂迷恋我的画师，把我画满了一整页的速写本。整张画面像一本被疯狂喜爱的角色速写本页面，充满凌乱、重叠且毫无规律的手绘涂鸦感。 包含： - 大量不同姿势的全身人物速写 - 多个夸张表情（开心、搞怪、害羞、震惊、得意、委屈等） -可爱的Q版（Chibi） 小人涂鸦 - 随机出现的几何图形以及美食 - 人物之间可以互相重叠、穿插排列 -页面边缘散落小爱心、星星、箭头、手写批注和随手画的小装饰 -整体像粉丝边画边犯花痴留下的涂鸦笔记 画面要求： -使用白色背景 - 不要网格、不要分区、不要整齐排版 -整体呈现“想到什么画什么”的混乱创作状态 人物要求： -保持照片中的五官特征和发型特点 -穿着时尚且具有美感的穿搭（颜色不限，可自由搭不同速写中可以更换更多风格服装。 特别要求：图片的最下方需要放置五个人的Q版形象的合照，按照我给你的图片顺序Q版形象旁边依次加上一下元素（鸽子，蜡笔，小鱼，刺猬，太阳），是一一对应的，五个元素不能少
